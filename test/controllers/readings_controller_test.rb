...
class ReadingsControllerTest < ActionController::TestCase
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post :create, reading: { inside_temperature: @reading.inside_temperature, outside_temperature: @reading.outside_temperature }
    end
  ...
  test "should update reading" do
    patch :update, id: @reading, reading: { inside_temperature: @reading.inside_temperature, outside_temperature: @reading.outside_temperature }
    assert_redirected_to reading_path(assigns(:reading))
  end
